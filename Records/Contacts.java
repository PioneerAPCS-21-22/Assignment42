...
public class Contacts
{
    ...
    /** 
     * President with given name, number, and email are added to list and list is sorted.
     *
     ...
     * @return President in the list with the name given using binary search and null if not found
     */
    public President getContact(String name)
    {
        ...
        while(high >= low) {
            ...
            else if(name.equals(people.get(mid).getName())) {
